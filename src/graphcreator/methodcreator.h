...
namespace cmpl {
  ...
  class MethodCreator : public Dispatcher, public std::enable_shared_from_this<MethodCreator> {
  private:
  ...
  class MethodCreatorError : public CreatorError 
  {
    public:
      MethodCreatorError(const char* err) : CreatorError(err) { }
  };
