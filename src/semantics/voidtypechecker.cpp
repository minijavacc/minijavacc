...
void VoidTypeChecker::dispatch(std::shared_ptr<SLCPrintlnExpression> n) { };
void VoidTypeChecker::dispatch(std::shared_ptr<SLCWriteExpression> n) { };
void VoidTypeChecker::dispatch(std::shared_ptr<SLCFlushExpression> n) { };
void VoidTypeChecker::dispatch(std::shared_ptr<SLCReadExpression> n) { };
