...
void ReturnChecker::dispatch(std::shared_ptr<SLCPrintlnExpression> n) { };
void ReturnChecker::dispatch(std::shared_ptr<SLCWriteExpression> n) { };
void ReturnChecker::dispatch(std::shared_ptr<SLCFlushExpression> n) { };
void ReturnChecker::dispatch(std::shared_ptr<SLCReadExpression> n) { };
